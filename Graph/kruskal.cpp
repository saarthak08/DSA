...
A minimum spanning tree is a tree which has lowest
Approach: Sort all the edges according to their weights and then take shortest edge at a time, include it to the tree.
Then, find if including the edge makes a cycle in the tree or not.
