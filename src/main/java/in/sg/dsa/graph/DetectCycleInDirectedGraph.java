 ...
 *
 * This program detects whether a given directed in.sg.dsa.graph contains a cycle.
 * The in.sg.dsa.graph is represented using an adjacency list, and Depth-First Search (DFS)
 * is used to traverse the in.sg.dsa.graph. A recursion stack is used to detect back edges,
 * which indicate cycles in directed graphs.
 *
 * Algorithm Explanation:
 * - We use DFS to explore the in.sg.dsa.graph starting from each unvisited node.
...
public class DetectCycleInDirectedGraph {
  ...
  private static boolean dfs(
      int vertex, ArrayList<Integer>[] adjList, boolean[] visited, boolean[] recursionStack) {
